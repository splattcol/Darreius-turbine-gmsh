...
/* ---- Mesh parameters ----*/
nPointCenter	= 15;		// Shaft nPoint
nPoint		    = 125; 		// Chord nPoint
nPointRotor 	= 240;		// RotateMesh nPoint
nPointFar 	    = 95;		// Farfield nPoint
...
nearShaft	    = 1.1;	// Near Shaft zone - structured mesh zone -!! nearShaft > 1 !!
...
nProg       = 1.055;    // Progression nearBladeZone
nearRatio   = 0.82;      // Ratio nearBlade and nPoint divitions
extBump     = 1.55;     // exterior Bump parameter - structured blade mesh zone - 
intBump     = 0.03;     // interior Bump parameter - structured blade mesh zone - 
