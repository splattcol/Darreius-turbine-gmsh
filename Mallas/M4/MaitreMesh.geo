...
nPoint		    = 75; 		// Chord nPoint
nPointRotor 	= 200;		// RotateMesh nPoint
nPointFar 	    = 55;		// Farfield nPoint
nPointInletOulet= 55;		// Inlet-Oulet nPoint
...
nProg       = 1.075;    // Progression nearBladeZone
nearRatio   = 1;      // Ratio nearBlade and nPoint divitions
extBump     = 1.5;     // exterior Bump parameter - structured blade mesh zone - 
