...
nPointRotor 	= 230;		// RotateMesh nPoint
nPointFar 	    = 85;		// Farfield nPoint
nPointInletOulet= 70;		// Inlet-Oulet nPoint
...
intBump     = 0.025;     // interior Bump parameter - structured blade mesh zone - 
